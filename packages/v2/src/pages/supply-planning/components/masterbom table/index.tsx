...
// }
var fields1 = [
  { name: "PO Name", field: "poName", edit: true, type: "string" },
  ...
  { name: "Amount", field: "amount", edit: true, type: "number" },
  { name: "Cost", field: "cost", edit: true, type: "number" },
];
var fields2 = [
  {
  ...
  { name: "Order Ship Date", field: "orderShipDate", edit: true, type: "string" },
  {
